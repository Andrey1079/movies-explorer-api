...
const { badRequestMessages } = require('../variables/apiMessages');
...
const movieSchema = new mongoose.Schema(
  {
    country: {
      ...
      minlength: [2, `2 ${badRequestMessages.minLength} "Страна"`],
    },
    director: {
      type: String,
    ...
    owner: {
      ...
      ref: 'user',
      required: [true, `"owner" ${badRequestMessages.required}`],
    },
    movieId: {
      type: Number,
      required: [true, `"id фильма" ${badRequestMessages.required}`],
    },
